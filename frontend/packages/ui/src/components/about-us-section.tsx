...
export default function AboutUsSection({ aboutImage }: { aboutImage: string }) {
  ...
  const stats = [
    { icon: <Award className="w-5 h-5" />, value: 120, label: "Projects Completed", suffix: "+" },
    { icon: <Users className="w-5 h-5" />, value: 1200, label: "Happy Clients", suffix: "+" },
    { icon: <Calendar className="w-5 h-5" />, value: 12, label: "Years Experience", suffix: "" },
    { icon: <TrendingUp className="w-5 h-5" />, value: 98, label: "Satisfaction Rate", suffix: "%" },
  ]
